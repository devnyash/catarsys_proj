...
export default function Sidebar() {
  ...
  return (
    <motion.aside
      ...
      className="fixed left-0 top-0 bottom-0 w-16 bg-[#0a0a0c]/90 backdrop-blur-xl border-r border-white/[0.06] z-40 flex flex-col items-center py-4"
    >
      {/* Logo */}
      <div className="mb-6">
        <div className="w-8 h-8 bg-gradient-to-br from-rose-500 to-rose-700 rounded-lg flex items-center justify-center shadow-lg shadow-rose-500/20">
          ...
          return (
            ...
            >
              ...
              {item.id === 'downloads' && activeDownloads > 0 && (
                <span className="absolute -top-0.5 -right-0.5 w-3.5 h-3.5 bg-emerald-500 text-[8px] font-bold text-white rounded-full flex items-center justify-center">
                  {activeDownloads}
                </span>
              )}
            </button>
